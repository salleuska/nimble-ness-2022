---
title: "Writing user distribitions"
...
```{r, use-dist-results, fig.width=12, fig.height=6, fig.cap='', fig.show='hide'}
...
![](`r knitr::fig_chunk("use-dist-results", "png")`)
