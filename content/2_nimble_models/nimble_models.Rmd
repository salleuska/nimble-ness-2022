...
Note we placed the prior directly on the standard deviation parameter. 
---
In BUGS or JAGS you would need to do this:
...
-- 
 ...
 - User-defined functions and distributions [more in the afternoon].
---
