...
```{r, data-example, eval=TRUE, echo=FALSE}
...
`r icon_style(fontawesome("exclamation-circle"), fill = "darkred")` They are not equivalent:
...
```{r, linmodel-graph, results ='hide', echo = FALSE, fig.width=10, fig.height=10}
...
edge.color <- "black"
stoch.color <- "skyblue1"
det.color <- "lightsalmon"
rhs.color <- "aliceblue"
fill.color <- c(
    rep(stoch.color, 3),
    rep(rhs.color, 4),
...
![](`r knitr::fig_chunk("linmodel-graph", "png")`)
