...
```{r eval=has_ggplot2, echo = FALSE,  fig.height=4.5, dpi = 300, fig.align='center'}
...
Results that comes with these slides are [here](orig_Ecervi_samples_mcmcplot.html). Results if you generated your own will be [here](Ecervi_samples_mcmcplot.html).


2. `coda`

```{r eval = FALSE}
# We haven't provided coda figures, but you can 
